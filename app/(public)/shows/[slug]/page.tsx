...
// titleImgSrc: the wide show-logo/title-card graphic shown in the header.
// Descriptions preserve original paragraph breaks (split on \n\n when rendering).
// logoHref = '' when network anchor pointed back at this page (treated as no link).
// ─────────────────────────────────────────────────────────────────────────────
type ShowData = {
  slug: string;
  title: string;
