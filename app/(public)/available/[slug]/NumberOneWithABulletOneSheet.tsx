...
// Rock red — loud, hard, electric, dangerous
const PRIMARY = '#CC2222';
// Deep warm red-black background
const BLACK   = '#0A0606';
// Dark crimson panel
const DARK    = '#150A0A';
const PANEL   = '#1E0E0E';
...
// Amp stack divider — horizontal bars like a classic Marshall stack
function AmpDivider() {
  return (
    <div style={{ position: 'relative', height: 28, background: BLACK, overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
        backgroundImage: `repeating-linear-gradient(90deg, ${PRIMARY}22 0px, ${PRIMARY}55 1px, transparent 1px, transparent 64px)`,
      }} />
      <div style={{
        position: 'absolute', inset: 0,
...
// Password gate — slug hardcoded to 'number-one-with-a-bullet'
function PasswordGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/marketing/available/verify-password', {
      ...
      body: JSON.stringify({ slug: 'number-one-with-a-bullet', password: pw }),
    });
    if (res.ok) {
      onUnlock();
    } else {
      ...
      <div style={{
        ...
        <form onSubmit={submit}>
          <input
            ...
            style={{
              width: '100%', padding: '12px 16px', background: '#120808', border: `1px solid ${PRIMARY}55`,
...
export default function NumberOneWithABulletOneSheet({ title }: { title: SafeTitle }) {
    ...
    <div style={{ background: BLACK, color: WHITE, fontFamily: "'Roboto', sans-serif", lineHeight: 1.6 }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative' }}>
          <div style={{ marginBottom: 16 }}>
            ...
            }}>True Crime Series · Hosted by Dee Snider</span>
          </div>
          <h1 style={{
            fontFamily: "'Roboto Condensed', sans-serif",
            fontWeight: 900, fontSize: 'clamp(50px, 7.5vw, 104px)',
            textTransform: 'uppercase', letterSpacing: '-0.01em',
            lineHeight: 0.9, margin: '0 0 20px', color: WHITE,
            textShadow: '0 4px 24px rgba(0,0,0,0.7)',
          }}>
            <span style={{ color: PRIMARY }}>#1</span> With<br />
            a Bullet
          </h1>
          <p style={{
            ...
            Twisted Sister frontman DEE SNIDER investigates the real, untold, shocking stories of music&apos;s most high-decibel crimes.
          </p>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '96px 48px', textAlign: 'center' }}>
        ...
        <blockquote style={{
          ...
          Dimebag Darrell. Selena. Nipsey Hussle.<br />
          Suge Knight. Phil Spector. Sid Vicious.<br />
          <span style={{ color: PRIMARY }}>Dee Snider knows where all the bodies are buried.</span>
        </blockquote>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 64, alignItems: 'start' }}>
            <div>
              <h2 style={{
                ...
                The music business has<br />
                secrets no one talks about.<br />
                <span style={{ color: PRIMARY }}>Dee&apos;s talking about them.</span>
              </h2>
            </div>
            <div style={{ color: `${WHITE}CC`, fontSize: 17, lineHeight: 1.75 }}>
              <p>
                <strong style={{ color: WHITE }}>Rock icon and Twisted Sister frontman DEE SNIDER</strong> is throwing the book at
                the music business in this true crime documentary series — investigating the real, untold,
                and shocking stories of the most high-decibel homicides in music history.
              </p>
              <p>
                Dee has seen things during his decades in the music business. Now he&apos;s revealing all —
                uncovering <strong style={{ color: WHITE }}>astonishing new evidence</strong>, revealing unforgettable archival footage,
                and conducting emotional interviews with bandmates, fellow stars, exes, law enforcement,
                and in some cases, the killers themselves.
              </p>
              <p>
                Stories include: <strong style={{ color: WHITE }}>James Brown</strong> — the Godfather of Soul, who died on Christmas Day
                2006 at age 73. No autopsy was ever performed. A close friend claims to have video that
                will prove foul play. To this day, it&apos;s unclear what really happened to Mr. Dynamite.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 48px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
          {[
            {
              heading: 'Dee Snider',
              body: 'Beyond Twisted Sister, Dee starred on Broadway (Rock of Ages), hosted the nationally syndicated Dee Snider\'s House of Hair radio show for nearly 30 years, and appeared in multiple hit reality shows. His unique access to the music world is unmatched.',
            },
            {
              heading: 'Every Genre',
              body: 'From rock to hip-hop, country to pop — murder, mayhem, and mystery from every corner of the music business. Dimebag Darrell, Selena, Nipsey Hussle, and many more untold stories.',
            },
            {
              heading: 'Inside Access',
              body: 'Stylistic recreations, astonishing new evidence, and emotional interviews with bandmates, fellow stars, exes, law enforcement, and sometimes the killers themselves. This is true crime with a backstage pass.',
            },
          ].map(({ heading, body }) => (
      ...
      <section style={{ background: DARK, padding: '80px 48px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <blockquote style={{
            ...
            &ldquo;He knows where all the bodies are buried.<br />
            <span style={{ color: PRIMARY }}>And he&apos;s ready to talk.&rdquo;</span>
          </blockquote>
          <p style={{
            ...
            #1 With a Bullet · Hosted by Dee Snider · Available Now
          </p>
          <a
            href="mailto:info@myentertainment.tv?subject=%231 With a Bullet — Acquisition Inquiry"
            style={{
