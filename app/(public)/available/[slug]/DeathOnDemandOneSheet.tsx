...
// Blood red — murder-for-hire, domestic betrayal
...
// Execution / countdown divider
function ExecutionDivider() {
  return (
    <div style={{ position: 'relative', height: 28, background: BLACK, overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
        backgroundImage: `repeating-linear-gradient(90deg, ${PRIMARY}22 0px, ${PRIMARY}44 1px, transparent 1px, transparent 68px)`,
      }} />
...
function PasswordGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/marketing/available/verify-password', {
      ...
      body: JSON.stringify({ slug: 'death-on-demand', password: pw }),
    });
    if (res.ok) {
      onUnlock();
    } else {
...
export default function DeathOnDemandOneSheet({ title }: { title: SafeTitle }) {
  ...
  return (
    <div style={{ background: BLACK, color: WHITE, fontFamily: "'Roboto', sans-serif", lineHeight: 1.6 }}>
      ...
      <section style={{ position: 'relative', height: '100vh', overflow: 'hidden', minHeight: 600 }}>
        <div style={{
          position: 'absolute', inset: 0,
          background: `linear-gradient(135deg, ${BLACK} 0%, ${DARK} 50%, #2A0A0A 100%)`,
        }} />
        <div style={{
          position: 'absolute', inset: 0,
          backgroundImage: `radial-gradient(ellipse at 25% 50%, ${PRIMARY}22 0%, transparent 50%), radial-gradient(ellipse at 75% 40%, ${PRIMARY}14 0%, transparent 45%)`,
        }} />
        <div style={{ position: 'relative', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '0 48px 64px' }}>
          <div style={{ marginBottom: 16 }}>
            ...
            }}>True Crime Anthology Series</span>
          </div>
          <h1 style={{
            fontFamily: "'Roboto Condensed', sans-serif",
            fontWeight: 900, fontSize: 'clamp(56px, 8vw, 112px)',
            textTransform: 'uppercase', letterSpacing: '-0.01em',
            lineHeight: 0.88, margin: '0 0 28px', color: WHITE,
            textShadow: '0 4px 24px rgba(0,0,0,0.8)',
          }}>
            Death on<br /><span style={{ color: PRIMARY }}>Demand</span>
          </h1>
          {/* Opening lines from the manifest — maximum impact */}
          <div style={{ maxWidth: 580, marginBottom: 16 }}>
            <p style={{
              color: `${WHITE}99`, fontSize: 13, fontStyle: 'italic', margin: '0 0 4px',
              fontFamily: "'Roboto Condensed', sans-serif",
            }}>
              &ldquo;I have no other option. He has destroyed our marriage&hellip;&rdquo;
            </p>
            <p style={{
              color: `${WHITE}77`, fontSize: 13, fontStyle: 'italic', margin: '0 0 4px',
              fontFamily: "'Roboto Condensed', sans-serif",
            }}>
              &ldquo;Half now, half after the job.&rdquo;
            </p>
            <p style={{
              color: `${WHITE}55`, fontSize: 13, fontStyle: 'italic', margin: 0,
              fontFamily: "'Roboto Condensed', sans-serif",
            }}>
              &ldquo;It&apos;s done.&rdquo;
            </p>
          </div>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '96px 48px', textAlign: 'center' }}>
        ...
        <blockquote style={{
          ...
          You trusted them.<br />
          They loved you.<br />
          <span style={{ color: PRIMARY }}>They wanted you dead.</span>
        </blockquote>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 64, alignItems: 'start' }}>
            <div>
              <h2 style={{
                ...
                Not strangers<br />
                in the dark.<br />
                <span style={{ color: PRIMARY }}>The person right beside you.</span>
              </h2>
            </div>
            <div style={{ color: `${WHITE}CC`, fontSize: 17, lineHeight: 1.75 }}>
              <p>
                DEATH ON DEMAND is a salacious true-crime anthology series that explores the shocking
                real-life cases where someone decided the only way forward was to pay someone else to end
                their loved one&apos;s life.
              </p>
              <p>
                Every episode follows a different story of betrayal — a marriage falling apart, a business
                deal gone bad, a love triangle that turned into a death sentence. The betrayal wasn&apos;t just
                that someone wanted them gone. It was that someone <em>pretended to love them</em> while
                secretly planning their murder.
              </p>
              <p>
                <strong style={{ color: WHITE }}>Each episode unfolds</strong> through emotional, raw and
                intimate interviews — intercut with archive home videos, exclusive evidence, and cinematic
                reenactments. The danger was always right beside them.
              </p>
            </div>
          </div>
        </div>
          ...
          {[
            {
              ...
              body: 'Spouses. Family members. Friends. Each episode begins by revealing how the killer and victim were intertwined — and how trust was twisted into something unrecognizable.',
            },
            {
              heading: 'The Tension',
              body: 'Something starts to go wrong: an affair, a hidden debt, a bruised ego. A grievance takes root. Instead of walking away, one person chooses to end it all by hiring a killer.',
            },
            {
              heading: 'The Format',
              body: 'Anthology series. Each closed-ended episode features a different murder-for-hire case. Emotional raw interviews, exclusive evidence, archive home videos, and cinematic reenactments.',
            },
          ].map(({ heading, body }) => (
      ...
      <section style={{ background: DARK, padding: '80px 48px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <blockquote style={{
            ...
            &ldquo;The person you think would do anything for you&hellip;<br />
            <span style={{ color: PRIMARY }}>would wind up doing the unthinkable.&rdquo;</span>
          </blockquote>
          <p style={{
            ...
            Death on Demand · True Crime Anthology · Available Now
          </p>
          <a
            href="mailto:info@myentertainment.tv?subject=Death on Demand — Acquisition Inquiry"
            style={{
