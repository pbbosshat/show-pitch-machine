...
export default function JoseFernandezOneSheet({ title }: { title: SafeTitle }) {
  ...
  return (
    <div style={{ background: BLACK, color: WHITE, fontFamily: "'Roboto', sans-serif", minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        background: `linear-gradient(135deg, ${BLACK} 0%, ${DARK} 50%, ${PRIMARY}33 100%)`,
        ...
        <div style={{ position: 'relative', maxWidth: 700 }}>
          ...
          <h1 style={{
            fontFamily: "'Roboto Condensed', sans-serif",
            fontWeight: 900, fontSize: 'clamp(40px, 6.5vw, 92px)',
            textTransform: 'uppercase', letterSpacing: '-0.01em',
            lineHeight: 0.9, margin: '0 0 32px', color: WHITE,
            textShadow: '0 4px 32px rgba(0,0,0,0.8)',
          }}>
            Jos&eacute;<br /><span style={{ color: PRIMARY }}>Fern&aacute;ndez</span>
          </h1>
          <div style={{
          ...
          <a
            href="mailto:info@myentertainment.tv?subject=José Fernández — Inquiry"
            style={{
