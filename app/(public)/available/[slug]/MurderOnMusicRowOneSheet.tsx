...
// Nashville gold — country music, grit, ambition
...
// Vinyl groove divider — concentric arc suggestion
function MusicRowDivider() {
  return (
    <div style={{ position: 'relative', height: 28, background: BLACK, overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
        backgroundImage: `repeating-linear-gradient(90deg, ${PRIMARY}1A 0px, ${PRIMARY}30 1px, transparent 1px, transparent 72px)`,
      }} />
      {/* Music note dot cluster */}
      <div style={{
        position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)',
        width: 24, height: 2, background: `linear-gradient(to right, transparent, ${PRIMARY}88, transparent)`,
      }} />
      <div style={{
        position: 'absolute', inset: 0,
...
function PasswordGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/marketing/available/verify-password', {
      ...
      body: JSON.stringify({ slug: 'murder-on-music-row', password: pw }),
    });
    if (res.ok) {
      onUnlock();
    } else {
      ...
      <div style={{
        ...
        <form onSubmit={submit}>
          <input
            ...
            style={{
              width: '100%', padding: '12px 16px', background: '#120E07', border: `1px solid ${PRIMARY}55`,
...
export default function MurderOnMusicRowOneSheet({ title }: { title: SafeTitle }) {
  ...
  return (
    <div style={{ background: BLACK, color: WHITE, fontFamily: "'Roboto', sans-serif", lineHeight: 1.6 }}>
      ...
      <section style={{ position: 'relative', height: '100vh', overflow: 'hidden', minHeight: 600 }}>
        <div style={{
          position: 'absolute', inset: 0,
          background: `linear-gradient(135deg, ${BLACK} 0%, ${DARK} 50%, #3A2200 100%)`,
        }} />
        <div style={{
          position: 'absolute', inset: 0,
          backgroundImage: `radial-gradient(ellipse at 30% 50%, ${PRIMARY}1A 0%, transparent 55%), radial-gradient(ellipse at 70% 30%, ${PRIMARY}12 0%, transparent 40%)`,
        }} />
        <div style={{ position: 'relative', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '0 48px 64px' }}>
          <div style={{ marginBottom: 16 }}>
            ...
            }}>3-Part Limited True Crime Series</span>
          </div>
          <h1 style={{
            fontFamily: "'Roboto Condensed', sans-serif",
            fontWeight: 900, fontSize: 'clamp(44px, 6.5vw, 96px)',
            textTransform: 'uppercase', letterSpacing: '-0.01em',
            lineHeight: 0.88, margin: '0 0 20px', color: WHITE,
            textShadow: '0 4px 24px rgba(0,0,0,0.8)',
          }}>
            Murder<br />on<br /><span style={{ color: PRIMARY }}>Music Row</span>
          </h1>
          <p style={{
            ...
            Based on the podcast/investigative series from Keith Sharon and The Tennessean
          </p>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '96px 48px', textAlign: 'center' }}>
        ...
        <blockquote style={{
          ...
          March 9, 1989.<br />
          A young singer named Faith Hill heard gunshots on Music Row.<br />
          <span style={{ color: PRIMARY }}>She ran toward the sound.</span>
        </blockquote>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 64, alignItems: 'start' }}>
            <div>
              <h2 style={{
                ...
                Nashville had<br />
                dirt under its fingernails.<br />
                <span style={{ color: PRIMARY }}>And someone pulled the trigger.</span>
              </h2>
            </div>
            <div style={{ color: `${WHITE}CC`, fontSize: 17, lineHeight: 1.75 }}>
              <p>
                On March 9, 1989, 23-year-old Kevin Hughes — chart researcher for Bug Music — was gunned down
                on the street in front of the office. The witnesses included a young singer-wannabe named
                Faith Hill. Willie Nelson and Kris Kristofferson were recording up the block. The Highwaymen.
                That&apos;s how close Music Row was to this murder.
              </p>
              <p>
                The music business was full of sharks and criminals. The ensuing decades-long homicide
                investigation exposed the dark underbelly of the country music industry — payola, hidden
                rivalries, bitter secrets kept for decades.
              </p>
              <p>
                <strong style={{ color: WHITE }}>Downloaded over 250,000 times</strong> across 164 countries,
                the podcast is now a gripping 3-part limited series. The cold case that rocked Music Row is
                finally getting its close-up.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 48px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
          {[
            {
              heading: 'The Victim',
              body: 'Kevin Hughes, 23 years old. Chart researcher at Bug Music — the company that owned the rights to "Fever," "What a Wonderful World," "I Walk the Line." Shot dead on Music Row in 1989.',
            },
            {
              heading: 'The Investigation',
              body: 'A 14-year, multi-state drama for lead detective Bill Pridemore. Suspicion fell on several people who didn\'t appreciate the attention. Were they killers, accomplices, or just murder-adjacent?',
            },
            {
              heading: 'The Source',
              body: 'Based on the hit true crime podcast "Murder on Music Row" by Keith Sharon and The Tennessean — 250,000+ downloads in 164+ countries worldwide. The definitive account of the case.',
            },
          ].map(({ heading, body }) => (
      ...
      <section style={{ background: DARK, padding: '80px 48px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <blockquote style={{
            ...
            &ldquo;The music business was full of sharks and criminals.<br />
            Were they killers, accomplices,<br />
            <span style={{ color: PRIMARY }}>or just murder-adjacent?&rdquo;</span>
          </blockquote>
          <p style={{
            ...
            Murder on Music Row · 3-Part Limited Series · Available Now
          </p>
          <a
            href="mailto:info@myentertainment.tv?subject=Murder on Music Row — Acquisition Inquiry"
            style={{
