...
// Teal / cyan — sterile, clinical, the technology of death
const PRIMARY = '#00B4B4';
// Deep blue-black background
const BLACK   = '#040A0A';
// Dark teal-tinged panel
const DARK    = '#081414';
const PANEL   = '#0C1C1C';
const MUTED   = '#3A6868';
const WHITE   = '#E8F5F5';

// Flatline divider — monitors going silent
  ...
  return (
    <div style={{ position: 'relative', height: 28, background: BLACK, overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        height: 1, background: `${PRIMARY}33`, transform: 'translateY(-50%)',
      }} />
      {/* Sparse vertical tick marks */}
      <div style={{
        position: 'absolute', inset: 0,
        backgroundImage: `repeating-linear-gradient(90deg, ${PRIMARY}22 0px, ${PRIMARY}44 1px, transparent 1px, transparent 96px)`,
      }} />
      <div style={{
        position: 'absolute', inset: 0,
...
// Password gate — slug hardcoded to 'exit-strategy'
function PasswordGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/marketing/available/verify-password', {
      ...
      body: JSON.stringify({ slug: 'exit-strategy', password: pw }),
    });
    if (res.ok) {
      onUnlock();
    } else {
      ...
      <div style={{
        ...
        <form onSubmit={submit}>
          <input
            ...
            style={{
              width: '100%', padding: '12px 16px', background: '#060E0E', border: `1px solid ${PRIMARY}55`,
...
export default function ExitStrategyOneSheet({ title }: { title: SafeTitle }) {
    ...
    <div style={{ background: BLACK, color: WHITE, fontFamily: "'Roboto', sans-serif", lineHeight: 1.6 }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative' }}>
          <div style={{ marginBottom: 16 }}>
            ...
            }}>Investigative Documentary · Global</span>
          </div>
          <h1 style={{
            fontFamily: "'Roboto Condensed', sans-serif",
            ...
            Exit<br />
            <span style={{ color: PRIMARY }}>Strategy</span>
          </h1>
          <p style={{
            ...
            A mother secretly travels to Switzerland. Her family learns of her death by WhatsApp.
          </p>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '96px 48px', textAlign: 'center' }}>
        ...
        <blockquote style={{
          ...
          From Swiss clinics to futuristic suicide pods —<br />
          where secrecy, profit, and technology collide<br />
          <span style={{ color: PRIMARY }}>where the law ends and instinct begins.</span>
        </blockquote>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 64, alignItems: 'start' }}>
            <div>
              <h2 style={{
                ...
                An industry that promises<br />
                dignity in death —<br />
                <span style={{ color: PRIMARY }}>but what does it really deliver?</span>
              </h2>
            </div>
            <div style={{ color: `${WHITE}CC`, fontSize: 17, lineHeight: 1.75 }}>
              <p>
                <strong style={{ color: WHITE }}>EXIT STRATEGY</strong> is an investigative documentary that begins with
                Maureen Slough, who told her family she was traveling to Lithuania — but instead secretly
                traveled to Switzerland for assisted suicide. Her daughter Megan received a WhatsApp message:
                <em> &ldquo;Your mom is in Switzerland… she wants an assisted suicide.&rdquo;</em> The next day, she was gone.
                Pegasos confirmed her death by text.
              </p>
              <p>
                Blindsided, the family discovered forged paperwork, opaque protocols, and a system that left
                them with more questions than closure. In parallel: the story of a 64-year-old American woman,
                the first reported to use the 3D-printed Sarco pod — marketed as the <em>&ldquo;Tesla of assisted dying&rdquo;</em> —
                whose debut sparked arrests and a firestorm of ethical debate.
              </p>
              <p>
                EXIT STRATEGY does not take a position for or against assisted suicide. Instead, it is grounded
                in the human experience of <strong style={{ color: WHITE }}>families blindsided, grieving, and outraged</strong>.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 48px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
          {[
            {
              heading: 'Dignitas & Beyond',
              body: 'From Dignitas in Zurich to the futuristic Sarco pod, the global assisted suicide industry operates largely out of public sight. This documentary goes inside — and demands accountability.',
            },
            {
              heading: 'WhatsApp Death',
              body: 'A family learns their mother has died by WhatsApp. A clinic confirms death by text. This is the human face of a booming, under-regulated industry where secrecy is the business model.',
            },
            {
              heading: 'Balanced Point of View',
              body: 'No agenda — just truth. EXIT STRATEGY follows the families left behind, exploring grief, choice, and the dangerous collision of profit and technology at the end of life.',
            },
          ].map(({ heading, body }) => (
      ...
      <section style={{ background: DARK, padding: '80px 48px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{
            ...
            Exit Strategy · Investigative Documentary · Available Now
          </p>
          <a
            href="mailto:info@myentertainment.tv?subject=Exit Strategy — Acquisition Inquiry"
            style={{
