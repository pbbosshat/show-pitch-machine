...
const BLACK   = '#080602';
// Dark amber-tinted panel
const DARK    = '#140B05';
const PANEL   = '#1C1108';
const MUTED   = '#7A5830';
const WHITE   = '#F5EEE0';

// Iron bars divider — vertical repeating lines
function BarsDivider() {
  return (
    <div style={{ position: 'relative', height: 28, background: BLACK, overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
        backgroundImage: `repeating-linear-gradient(90deg, ${PRIMARY}22 0px, ${PRIMARY}44 2px, transparent 2px, transparent 32px)`,
      }} />
      <div style={{
        position: 'absolute', inset: 0,
...
// Password gate — slug hardcoded to 'up-for-parole'
function PasswordGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/marketing/available/verify-password', {
      ...
      body: JSON.stringify({ slug: 'up-for-parole', password: pw }),
    });
    if (res.ok) {
      onUnlock();
    } else {
      ...
      <div style={{
        ...
        <form onSubmit={submit}>
          <input
            ...
            style={{
              width: '100%', padding: '12px 16px', background: '#0E0905', border: `1px solid ${PRIMARY}55`,
...
export default function UpForParoleOneSheet({ title }: { title: SafeTitle }) {
    ...
    <div style={{ background: BLACK, color: WHITE, fontFamily: "'Roboto', sans-serif", lineHeight: 1.6 }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative' }}>
          <div style={{ marginBottom: 16 }}>
            ...
            }}>True Crime Series · Explosive</span>
          </div>
          <h1 style={{
            fontFamily: "'Roboto Condensed', sans-serif",
            ...
            Up for<br />
            <span style={{ color: PRIMARY }}>Parole</span>
          </h1>
          <p style={{
            ...
            &ldquo;Can one of the most infamous killers of all time be let out of prison and wind up shopping in your local grocery store?&rdquo;
          </p>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '96px 48px', textAlign: 'center' }}>
        ...
        <blockquote style={{
          ...
          The Manson Family. The Candyman.<br />
          Kemper. Saldivar.<br />
          <span style={{ color: PRIMARY }}>All household names. All ready to face FREEDOM.</span>
        </blockquote>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 64, alignItems: 'start' }}>
            <div>
              <h2 style={{
                ...
                Ripped from today&apos;s headlines —<br />
                <span style={{ color: PRIMARY }}>the parole hearings</span><br />
                keeping America awake at night.
              </h2>
            </div>
            <div style={{ color: `${WHITE}CC`, fontSize: 17, lineHeight: 1.75 }}>
              <p>
                <strong style={{ color: WHITE }}>UP FOR PAROLE</strong> is an explosive series that highlights the nation&apos;s most
                famous and violent cases at the exact moment when these notorious offenders face a crucial
                parole hearing — to determine if they are fit for release or will serve life behind bars.
              </p>
              <p>
                Ripped from the headlines: violent offenders from the past are about to plea before a parole
                board for the opportunity to live a normal life. Each episode re-examines these cases,
                goes inside courtrooms, and leads up to the decision that will keep America awake at night.
              </p>
              <p>
                Every episode concludes with the parole board&apos;s final decision: <strong style={{ color: WHITE }}>let these
                violent offenders continue to serve their sentence — or walk free</strong>.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 48px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
          {[
            {
              heading: 'Household Names',
              body: 'The Manson Family, The Candyman, Kemper, Saldivar — names burned into American consciousness. This series revisits the cases that defined true crime and asks the impossible question.',
            },
            {
              heading: 'Real Verdicts',
              body: 'Each episode concludes with a real parole board decision — fit for release or lifetime incarceration. The stakes couldn\'t be higher for the offenders, the victims\' families, or the public.',
            },
            {
              heading: 'Ripped From Headlines',
              body: 'Yolanda Saldívar\'s first parole hearing: March 30, 2025. These timely hearings give the series an urgent, ripped-from-today\'s-headlines energy that no other true crime show can match.',
            },
          ].map(({ heading, body }) => (
      ...
      <section style={{ background: DARK, padding: '80px 48px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <blockquote style={{
            ...
            &ldquo;Can one of the most infamous killers of all time<br />
            be let out of prison and wind up shopping in<br />
            <span style={{ color: PRIMARY }}>your local grocery store?&rdquo;</span>
          </blockquote>
          <p style={{
            ...
            Up for Parole · True Crime Series · Available Now
          </p>
          <a
            href="mailto:info@myentertainment.tv?subject=Up for Parole — Acquisition Inquiry"
            style={{
