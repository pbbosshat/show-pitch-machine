...
// Golf green — classic, sport-forward, confident
const PRIMARY = '#2E7D32';
// Near-black with faint cool undertone
const BLACK   = '#040608';
// Dark panel surfaces
const DARK    = '#08100A';
const PANEL   = '#0D1810';
// Muted fairway for secondary text
const MUTED   = '#2A5C2E';
// Clean off-white
const WHITE   = '#EFF4EF';

// Fairway-stripe divider — clean alternating lines evoking a groomed course
function FairwayDivider() {
  return (
    <div style={{ position: 'relative', height: 28, background: BLACK, overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
        backgroundImage: `repeating-linear-gradient(90deg, ${PRIMARY}33 0px, ${PRIMARY}55 1px, transparent 1px, transparent 110px)`,
      }} />
      <div style={{
        position: 'absolute', inset: 0,
...
// Password gate — slug hardcoded as 'swing-thoughts'
function PasswordGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/marketing/available/verify-password', {
      ...
      body: JSON.stringify({ slug: 'swing-thoughts', password: pw }),
    });
    if (res.ok) {
      onUnlock();
    } else {
      ...
      <div style={{
        ...
        <form onSubmit={submit}>
          <input
            ...
            style={{
              width: '100%', padding: '12px 16px', background: '#060E08', border: `1px solid ${PRIMARY}55`,
...
export default function SwingThoughtsOneSheet({ title }: { title: SafeTitle }) {
  ...
  return (
    <div style={{ background: BLACK, color: WHITE, fontFamily: "'Roboto', sans-serif", lineHeight: 1.6 }}>
      ...
      <section style={{ position: 'relative', height: '100vh', overflow: 'hidden', minHeight: 600 }}>
        ...
        <div style={{
          position: 'absolute', inset: 0,
          background: `radial-gradient(ellipse 65% 50% at 50% 55%, ${PRIMARY}18 0%, transparent 70%)`,
        }} />
        <div style={{ position: 'relative', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '0 48px 64px' }}>
          <div style={{ marginBottom: 16 }}>
            ...
            }}>Golf · Lifestyle · 30-Minute Series</span>
          </div>
          <h1 style={{
            fontFamily: "'Roboto Condensed', sans-serif",
            ...
            Swing<br />
            <span style={{ color: PRIMARY }}>Thoughts</span>
          </h1>
          <p style={{
            ...
            &ldquo;A show where the golf world meets personality, untold stories, and a little friendly competition.&rdquo;
          </p>
          <p style={{ color: MUTED, fontSize: 13, fontFamily: "'Roboto Condensed', sans-serif", letterSpacing: '0.1em', textTransform: 'uppercase' }}>
            Hosted by Sara Winter &nbsp;·&nbsp; MY Entertainment
          </p>
        </div>
      </section>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '96px 48px', textAlign: 'center' }}>
        ...
        <blockquote style={{
          ...
          <span style={{ color: PRIMARY }}>Inside the game.</span>
        </blockquote>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 64, alignItems: 'start' }}>
            <div>
              <h2 style={{
                ...
                Serious golf.<br />
                Real stories.<br />
                <span style={{ color: PRIMARY }}>Zero pretension.</span>
              </h2>
            </div>
            <div style={{ color: `${WHITE}CC`, fontSize: 17, lineHeight: 1.75 }}>
              <p>
                <strong style={{ color: WHITE }}>SWING THOUGHTS with Sara Winter</strong> is a 30-minute series
                that brings viewers onto the driving range for an intimate, entertaining, and informative look at
                professional golfers — their lives on and off the tour, and the skills that make them great.
              </p>
              <p>
                Each episode, Sara charms viewers in a one-on-one conversation with a golf pro as they warm up
                on the range. Sara draws out stories that go beyond the leaderboard: personal moments, funny
                behind-the-scenes from tour life, and the challenges of playing at the highest level.
              </p>
              <p>
                The series also features a hands-on segment where Sara and her guest work on a specific skill
                together — plus a <strong style={{ color: WHITE }}>lighthearted challenge</strong> (closest-to-the-pin,
                skill-based mini-competition) that keeps viewers engaged at every level of golf interest.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 48px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
          {[
            {
              heading: 'The Host',
              body: 'Beloved Canadian golfer Sara Winter brings warmth, expertise, and genuine curiosity to every conversation — making the game approachable for casual fans while satisfying dedicated golf enthusiasts.',
            },
            {
              heading: 'The Format',
              body: '30 minutes. Driving range setting. Skill instruction, personal storytelling, and a competitive mini-challenge per episode. Visually dynamic with ball tracking, slow-motion action, and swing close-ups.',
            },
            {
              heading: 'Social-Friendly',
              body: 'Energetic, fun, and built for sharing — YouTube, TikTok, and Instagram-friendly moments built into every episode. Rotating lineup of top touring pros promises fresh content week after week.',
            },
          ].map(({ heading, body }) => (
      ...
      <section style={{ background: DARK, padding: '80px 48px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{
            ...
            Swing Thoughts · Golf Lifestyle Series · Available Now
          </p>
          <a
            href="mailto:info@myentertainment.tv?subject=Swing Thoughts — Acquisition Inquiry"
            style={{
