...
// Gallery frame / brushstroke divider
function ArtDivider() {
  return (
    <div style={{ position: 'relative', height: 28, background: BLACK, overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
        backgroundImage: `repeating-linear-gradient(90deg, ${PRIMARY}1A 0px, ${PRIMARY}33 1px, transparent 1px, transparent 110px)`,
      }} />
      {/* Three dots — like ellipsis or gallery spotlights */}
      <div style={{
...
function PasswordGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/marketing/available/verify-password', {
      ...
      body: JSON.stringify({ slug: 'art-of-murder-walshe', password: pw }),
    });
    if (res.ok) {
      onUnlock();
    } else {
      ...
      <div style={{
        ...
        <form onSubmit={submit}>
          <input
            ...
            style={{
              width: '100%', padding: '12px 16px', background: '#0E0810', border: `1px solid ${PRIMARY}55`,
...
export default function ArtOfMurderWalsheOneSheet({ title }: { title: SafeTitle }) {
  ...
  return (
    <div style={{ background: BLACK, color: WHITE, fontFamily: "'Roboto', sans-serif", lineHeight: 1.6 }}>
      ...
      <section style={{ position: 'relative', height: '100vh', overflow: 'hidden', minHeight: 600 }}>
        <div style={{
          position: 'absolute', inset: 0,
          background: `linear-gradient(135deg, ${BLACK} 0%, ${DARK} 50%, #2A1A00 100%)`,
        }} />
        <div style={{
          position: 'absolute', inset: 0,
          backgroundImage: `radial-gradient(ellipse at 35% 45%, ${PRIMARY}18 0%, transparent 55%), radial-gradient(ellipse at 75% 60%, ${PRIMARY}10 0%, transparent 45%)`,
        }} />
        <div style={{ position: 'relative', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '0 48px 64px' }}>
          <div style={{ marginBottom: 16 }}>
            ...
            }}>3-Part Documentary Event · True Crime</span>
          </div>
          <h1 style={{
            fontFamily: "'Roboto Condensed', sans-serif",
            fontWeight: 900, fontSize: 'clamp(42px, 6vw, 88px)',
            textTransform: 'uppercase', letterSpacing: '-0.01em',
            lineHeight: 0.9, margin: '0 0 20px', color: WHITE,
            textShadow: '0 4px 24px rgba(0,0,0,0.8)',
          }}>
            The Art of<br /><span style={{ color: PRIMARY }}>Murder</span>
          </h1>
          <p style={{
            fontSize: 'clamp(14px, 1.6vw, 18px)', fontWeight: 400,
            color: `${WHITE}BB`, maxWidth: 600, margin: '0 0 8px',
            fontStyle: 'italic',
            textShadow: '0 2px 12px rgba(0,0,0,0.7)',
          }}>
            Trial of Brian Walshe &mdash; Norfolk County, Massachusetts &mdash; November 2025
          </p>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '96px 48px', textAlign: 'center' }}>
        ...
        <blockquote style={{
          ...
          An international art scam.<br />
          A missing wife. A trial 3 years in the making.<br />
          <span style={{ color: PRIMARY }}>What really happened to Ana Walshe?</span>
        </blockquote>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 64, alignItems: 'start' }}>
            <div>
              <h2 style={{
                ...
                of suburban bliss.<br />
                <span style={{ color: PRIMARY }}>A web of deceit.</span>
              </h2>
            </div>
            <div style={{ color: `${WHITE}CC`, fontSize: 17, lineHeight: 1.75 }}>
              <p>
                On New Year&apos;s Day 2023, Ana Walshe — a devoted mother of three with a seemingly picture-perfect
                life — vanished from her home in Cohasset, Massachusetts. Her disappearance shattered a quiet
                seaside town and ignited a national media firestorm.
              </p>
              <p>
                Behind the facade: an international art scam, a million-dollar inheritance feud, and troubling
                police reports. Brian Walshe — art dealer, accused forger of Warhols, and defrauder of his own
                family — stood at the center of it all. Ana&apos;s body has never been found.
              </p>
              <p>
                <strong style={{ color: WHITE }}>November 2025:</strong> The long-awaited trial finally begins —
                investigated by the same police department involved in the Karen Read trial. This isn&apos;t just
                another true crime series: it&apos;s a cultural moment.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 48px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
          {[
            {
              heading: 'The Accused',
              body: 'Brian Walshe — art dealer accused of selling forged Warhols, defrauding his own family, and murdering his wife. His defense team plans to exploit every ambiguity in the investigation.',
            },
            {
              heading: 'The Trial',
              body: 'Norfolk County, Massachusetts — November 2025. The verdict still unwritten. Investigated by the same department behind the Karen Read case. This trial will define the moment.',
            },
            {
              heading: 'The Cultural Moment',
              body: 'From TikTok obsession to wall-to-wall media coverage, the Walshe case has captured the nation\'s imagination. Will jurors see a manipulator — or a husband condemned by circumstance?',
            },
          ].map(({ heading, body }) => (
      ...
      <section style={{ background: DARK, padding: '80px 48px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <blockquote style={{
            ...
            &ldquo;To this day,<br />
            Ana&apos;s body has never been found.&rdquo;
          </blockquote>
          <p style={{
            ...
            The Art of Murder: Walshe · 3-Part Documentary · Available Now
          </p>
          <a
            href="mailto:info@myentertainment.tv?subject=Art of Murder Walshe — Acquisition Inquiry"
            style={{
