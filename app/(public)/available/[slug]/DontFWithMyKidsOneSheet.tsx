...
const BLACK   = '#08040A';
// Dark magenta-tinged panel
const DARK    = '#100614';
const PANEL   = '#180A1C';
const MUTED   = '#7A3A60';
const WHITE   = '#F5EAF2';

// Hot pulse divider — motherly intensity
function PulseDivider() {
  return (
    <div style={{ position: 'relative', height: 24, background: BLACK, overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
        backgroundImage: `repeating-linear-gradient(90deg, ${PRIMARY}22 0px, ${PRIMARY}55 1px, transparent 1px, transparent 56px)`,
      }} />
      <div style={{
        position: 'absolute', inset: 0,
...
// Password gate — slug hardcoded to 'dont-f-with-my-kids'
function PasswordGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/marketing/available/verify-password', {
      ...
      body: JSON.stringify({ slug: 'dont-f-with-my-kids', password: pw }),
    });
    if (res.ok) {
      onUnlock();
    } else {
      ...
      <div style={{
        ...
        <form onSubmit={submit}>
          <input
            ...
            style={{
              width: '100%', padding: '12px 16px', background: '#0C0610', border: `1px solid ${PRIMARY}55`,
...
export default function DontFWithMyKidsOneSheet({ title }: { title: SafeTitle }) {
    ...
    <div style={{ background: BLACK, color: WHITE, fontFamily: "'Roboto', sans-serif", lineHeight: 1.6 }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative' }}>
          <div style={{ marginBottom: 16 }}>
            ...
            }}>Unscripted Series · Protective Moms</span>
          </div>
          <h1 style={{
            fontFamily: "'Roboto Condensed', sans-serif",
            ...
            Don&apos;t F<br />
            <span style={{ color: PRIMARY }}>With</span><br />
            My Kids
          </h1>
          <p style={{
            ...
            &ldquo;There is no deeper love, no stronger bond... so don&apos;t you DARE get between a Mom and her baby.&rdquo;
          </p>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '96px 48px', textAlign: 'center' }}>
        ...
        <blockquote style={{
          ...
          If your child is threatened:<br />
          Would you keep your cool?<br />
          <span style={{ color: PRIMARY }}>Or burn the world to the ground?</span>
        </blockquote>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 64, alignItems: 'start' }}>
            <div>
              <h2 style={{
                ...
                All that pressure<br />
                is causing some moms<br />
                <span style={{ color: PRIMARY }}>to snap.</span>
              </h2>
            </div>
            <div style={{ color: `${WHITE}CC`, fontSize: 17, lineHeight: 1.75 }}>
              <p>
                With &ldquo;Insta-Perfect Mom-fluencers&rdquo; causing intense self-scrutiny, an endless barrage of online
                &ldquo;experts&rdquo; claiming to know what&apos;s best for your kid, and cellphone cameras watching their
                every move — women are facing more pressure than ever to be the ultimate Supermom.
              </p>
              <p>
                <strong style={{ color: WHITE }}>DON&apos;T F WITH MY KIDS</strong> celebrates and explores the moms who get pushed
                beyond their limits and push back. Protective mothers vs. impossible modern parenting pressure.
                Lying. Stealing. Screaming. Physical assault. Vigilante justice.
              </p>
              <p>
                In the heat of the moment — <strong style={{ color: WHITE }}>is anything off limits when it comes to defending your kid?</strong>{' '}
                These moms don&apos;t think so. And they&apos;re not sorry.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 48px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
          {[
            {
              heading: 'Mom-fluencer Pressure',
              body: 'The "Insta-Perfect" parenting industrial complex has created impossible standards. This series shows what happens when real moms stop performing and start protecting.',
            },
            {
              heading: 'Protective & Raw',
              body: 'No judgment, no safety net — just real moms facing real threats to their children and doing what they have to do. From vigilante justice to physical confrontation.',
            },
            {
              heading: 'Universal Hook',
              body: '"How far would you go?" is a question every parent asks. This series answers it — explosively and honestly — episode after episode.',
            },
          ].map(({ heading, body }) => (
      ...
      <section style={{ background: DARK, padding: '80px 48px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <blockquote style={{
            ...
            &ldquo;There is no deeper love,<br />
            no stronger bond...<br />
            <span style={{ color: PRIMARY }}>so don&apos;t you DARE.&rdquo;</span>
          </blockquote>
          <p style={{
            ...
            Don&apos;t F With My Kids · Unscripted Series · Available Now
          </p>
          <a
            href="mailto:info@myentertainment.tv?subject=Don't F With My Kids — Acquisition Inquiry"
            style={{
