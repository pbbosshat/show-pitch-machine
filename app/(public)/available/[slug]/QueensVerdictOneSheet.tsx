...
// Pride purple — queer identity, royalty, bold compassion
const PRIMARY = '#9B59B6';
// Near-black backgrounds — deep purple undertone
const BLACK   = '#06050A';
const DARK    = '#0F0814';
const PANEL   = '#160C1E';
...
// Gavel-strike divider — courtroom authority with a queer edge
function QueerCourtDivider() {
  return (
    <div style={{ position: 'relative', height: 32, background: BLACK, overflow: 'hidden' }}>
      {/* Double line — like a judge&apos;s bench edge */}
      <div style={{
        position: 'absolute', top: 10, left: 48, right: 48, height: 1,
        background: `linear-gradient(to right, transparent, ${PRIMARY}44 20%, ${PRIMARY}88 50%, ${PRIMARY}44 80%, transparent)`,
      }} />
      <div style={{
        position: 'absolute', top: 16, left: 48, right: 48, height: 1,
        background: `linear-gradient(to right, transparent, ${PRIMARY}22 20%, ${PRIMARY}44 50%, ${PRIMARY}22 80%, transparent)`,
      }} />
    </div>
  );
}
...
function PasswordGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/marketing/available/verify-password', {
      ...
      body: JSON.stringify({ slug: 'queens-verdict', password: pw }),
    });
    if (res.ok) {
      onUnlock();
    } else {
      ...
      <div style={{
        ...
        <form onSubmit={submit}>
          <input
            ...
            style={{
              width: '100%', padding: '12px 16px', background: '#0C070F', border: `1px solid ${PRIMARY}55`,
...
export default function QueensVerdictOneSheet({ title }: { title: SafeTitle }) {
  ...
  return (
    <div style={{ background: BLACK, color: WHITE, fontFamily: "'Roboto', sans-serif", lineHeight: 1.6 }}>
      ...
      <section style={{ position: 'relative', height: '100vh', overflow: 'hidden', minHeight: 600 }}>
        ...
        {/* Neon grid — courtroom meets club */}
        <div style={{
          position: 'absolute', inset: 0,
          backgroundImage: `repeating-linear-gradient(90deg, ${PRIMARY}08 0px, transparent 1px, transparent 80px)`,
        }} />
        <div style={{ position: 'relative', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '0 48px 64px' }}>
          ...
          <h1 style={{
            ...
            Queer<br />
            <span style={{ color: PRIMARY }}>Court</span>
          </h1>
          <p style={{
            ...
            Love Is Love: Until It&apos;s Not. — Also known as Queen&apos;s Verdict
          </p>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '96px 48px', textAlign: 'center' }}>
        ...
        <blockquote style={{
          ...
          and the tea is subpoenaed.<br />
          <span style={{ color: PRIMARY }}>Justice, with compassion and contour.</span>
        </blockquote>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 64, alignItems: 'start' }}>
            <div>
              <h2 style={{
                ...
                Forget daytime<br />divorce court.<br />
                <span style={{ color: PRIMARY }}>This is for the queer generation.</span>
              </h2>
            </div>
            <div style={{ color: `${WHITE}CC`, fontSize: 17, lineHeight: 1.75 }}>
              <p>
                When queer relationships hit the breaking point, Queer Court steps in to deliver justice —
                with compassion and contour. A sharp, heartfelt, and hilarious courtroom reality series where
                LGBTQ+ couples and exes face off before a drag-queen judge and a licensed therapist.
              </p>
              <p>
                Each episode brings queer couples and exes to a neon-lit bench to hash out the messy middle:
                soon-to-be exes seeking clarity, ex-exes still fighting for closure, situationships battling
                over love, loyalty, and shared pets.
              </p>
              <p>
                Think <em>Judge Judy</em> meets <em>Drag Race: Untucked</em> meets <em>Couples Therapy</em> —
                where <strong style={{ color: WHITE }}>every verdict comes with a little healing and a lot of shade</strong>.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 48px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
          {[
            {
              heading: 'The Judge',
              body: 'A commanding drag-queen judge — charismatic, emotionally fluent. Delivers rulings that balance wit and wisdom with a perfectly timed eye-roll.',
            },
            {
              heading: 'The Co-Judge',
              body: 'A licensed therapist who grounds the emotion — offering perspective, real-world insight, and the heart in the hurricane.',
            },
            {
              heading: 'The Truth Bailiff',
              body: 'A social-media sleuth who calls out contradictions in real time — revealing "Exhibit A: the group chat."',
            },
          ].map(({ heading, body }) => (
      ...
      <section style={{ background: DARK, padding: '80px 48px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <blockquote style={{
            ...
            &ldquo;When queer love gets complicated,<br />
            <span style={{ color: PRIMARY }}>Queer Court is where we sort the heart from the hype.&rdquo;</span>
          </blockquote>
          <p style={{
            ...
            Queen&apos;s Verdict · Courtroom Reality · Available Now
          </p>
          <a
            href="mailto:info@myentertainment.tv?subject=Queen's Verdict — Acquisition Inquiry"
            style={{
