...
// Electric blue — high-energy, fan-crowd electricity
...
// Stadium-light divider — repeating lines evoking overhead venue lighting
function StadiumDivider() {
  return (
    <div style={{ position: 'relative', height: 28, background: BLACK, overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
        backgroundImage: `repeating-linear-gradient(90deg, ${PRIMARY}33 0px, ${PRIMARY}55 1px, transparent 1px, transparent 75px)`,
      }} />
      <div style={{
        position: 'absolute', inset: 0,
...
// Password gate — slug hardcoded as 'fandemonium'
function PasswordGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/marketing/available/verify-password', {
      ...
      body: JSON.stringify({ slug: 'fandemonium', password: pw }),
    });
    if (res.ok) {
      onUnlock();
    } else {
      ...
      <div style={{
        ...
        <form onSubmit={submit}>
          <input
            ...
            style={{
              width: '100%', padding: '12px 16px', background: '#060618', border: `1px solid ${PRIMARY}55`,
...
export default function FandemoniumOneSheet({ title }: { title: SafeTitle }) {
  ...
  return (
    <div style={{ background: BLACK, color: WHITE, fontFamily: "'Roboto', sans-serif", lineHeight: 1.6 }}>
      ...
      <section style={{ position: 'relative', height: '100vh', overflow: 'hidden', minHeight: 600 }}>
        ...
        <div style={{
          position: 'absolute', inset: 0,
          background: `radial-gradient(ellipse 70% 55% at 50% 60%, ${PRIMARY}18 0%, transparent 70%)`,
        }} />
        <div style={{ position: 'relative', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '0 48px 64px' }}>
          <div style={{ marginBottom: 16 }}>
            ...
            }}>Half-Hour Clip Series · Music Fans · All Genres</span>
          </div>
          <h1 style={{
            fontFamily: "'Roboto Condensed', sans-serif",
            ...
            color: WHITE,
            textShadow: `0 4px 24px rgba(0,0,0,0.8), 0 0 80px ${PRIMARY}33`,
          }}>
            Fande<span style={{ color: PRIMARY }}>monium</span>
          </h1>
          <p style={{
            ...
            &ldquo;Ridiculousness for Music Fans!&rdquo;
          </p>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '96px 48px', textAlign: 'center' }}>
        ...
        <blockquote style={{
          ...
          Music fans are crazy&mdash;<br />
          <span style={{ color: PRIMARY }}>in the best way!</span>
        </blockquote>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 64, alignItems: 'start' }}>
            <div>
              <h2 style={{
                ...
                to the hotel room&mdash;<br />
                <span style={{ color: PRIMARY }}>the whole journey.</span>
              </h2>
            </div>
            <div style={{ color: `${WHITE}CC`, fontSize: 17, lineHeight: 1.75 }}>
              <p>
                From pre-show stunts in parking lots to hotel-room craziness, music fans know how to celebrate
                when their favorite artists come to town. They jam out to new albums on the way to the venue,
                play beer pong and flip cup tournaments, grill at country tailgates, and fly 3,000 miles to
                sold-out performances.
              </p>
              <p>
                <strong style={{ color: WHITE }}>FANDEMONIUM</strong> is a half-hour clip show that takes us
                through all those memories posted on social media — as our host and three weekly guests countdown
                the best moments that happen on the Way To The Show.
              </p>
              <p>
                Each episode takes on a <strong style={{ color: WHITE }}>different genre of music</strong> —
                because everyone preps for their favorite artist differently. From rowdy drinking games to wild
                stunts by concert-goers who played too many rounds of Thunderstruck, these clips celebrate the
                best of music fandom.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 48px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
          {[
            {
              heading: 'The Format',
              body: '30 minutes. Host + 3 rotating weekly guests count down the best music fan moments from social media. Half countdown show, half celebration of the live music experience.',
            },
            {
              heading: 'Genre Rotation',
              body: 'Each episode focuses on a different genre — country, hip-hop, pop, rock, EDM — because every fanbase has its own rituals, stunts, and tailgate traditions.',
            },
            {
              heading: 'The Ridiculousness Comp',
              body: 'A proven clip-show format applied to the music fan space — the energy of Ridiculousness with the universal passion of live music culture. Broad demographic appeal across age and genre.',
            },
          ].map(({ heading, body }) => (
      ...
      <section style={{ background: DARK, padding: '80px 48px' }}>
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          <blockquote style={{
            ...
            &ldquo;Music Fans Are Crazy&hellip; In the Best Way!&rdquo;
          </blockquote>
          <p style={{
            ...
            Fandemonium · Half-Hour Clip Series · Available Now
          </p>
          <a
            href="mailto:info@myentertainment.tv?subject=Fandemonium — Acquisition Inquiry"
            style={{
